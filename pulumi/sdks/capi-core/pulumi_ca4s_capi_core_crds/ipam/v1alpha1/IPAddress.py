...
@pulumi.type_token("kubernetes:ipam.cluster.x-k8s.io/v1alpha1:IPAddress")
class IPAddress(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:ipam.cluster.x-k8s.io/v1beta1:IPAddress"), pulumi.Alias(type_="kubernetes:ipam.cluster.x-k8s.io/v1beta2:IPAddress")])
