...
@pulumi.type_token("kubernetes:ipam.cluster.x-k8s.io/v1beta1:IPAddressPatch")
class IPAddressPatch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:ipam.cluster.x-k8s.io/v1alpha1:IPAddressPatch"), pulumi.Alias(type_="kubernetes:ipam.cluster.x-k8s.io/v1beta2:IPAddressPatch")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IPAddressPatch, __self__).__init__(
            'kubernetes:ipam.cluster.x-k8s.io/v1beta1:IPAddressPatch',
            resource_name,
            __props__,
            opts)
