...
class IPAddressListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['IPAddressArgs']]] items: List of ipaddresses. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
...
@pulumi.type_token("kubernetes:ipam.cluster.x-k8s.io/v1beta1:IPAddressList")
class IPAddressList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['IPAddressArgs', 'IPAddressArgsDict']]]] items: List of ipaddresses. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        :param pulumi.Input[_builtins.str] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    def _internal_init(__self__,
        ...
        super(IPAddressList, __self__).__init__(
            'kubernetes:ipam.cluster.x-k8s.io/v1beta1:IPAddressList',
            resource_name,
            __props__,
            opts)
