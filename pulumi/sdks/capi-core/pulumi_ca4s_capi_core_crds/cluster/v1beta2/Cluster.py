...
@pulumi.type_token("kubernetes:cluster.x-k8s.io/v1beta2:Cluster")
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:cluster.x-k8s.io/v1beta1:Cluster")])
