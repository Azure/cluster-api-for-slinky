...
def get_sensitive_file(filename: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('local:index/getSensitiveFile:getSensitiveFile', __args__, opts=opts, typ=GetSensitiveFileResult, package_ref=_utilities.get_package()).value
...
def get_sensitive_file_output(filename: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('local:index/getSensitiveFile:getSensitiveFile', __args__, opts=opts, typ=GetSensitiveFileResult, package_ref=_utilities.get_package())
