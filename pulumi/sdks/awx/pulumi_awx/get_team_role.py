...
def get_team_role(id: Optional[_builtins.float] = None,
    ...
    __ret__ = pulumi.runtime.invoke('awx:index/getTeamRole:getTeamRole', __args__, opts=opts, typ=GetTeamRoleResult, package_ref=_utilities.get_package()).value

    return AwaitableGetTeamRoleResult(
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'),
        team_id=pulumi.get(__ret__, 'team_id'))
def get_team_role_output(id: pulumi.Input[Optional[Optional[_builtins.float]]] = None,
                         name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         team_id: pulumi.Input[Optional[_builtins.float]] = None,
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTeamRoleResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('awx:index/getTeamRole:getTeamRole', __args__, opts=opts, typ=GetTeamRoleResult, package_ref=_utilities.get_package())
    return __ret__.apply(lambda __response__: GetTeamRoleResult(
