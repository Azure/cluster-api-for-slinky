...
def get_organizations(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('awx:index/getOrganizations:getOrganizations', __args__, opts=opts, typ=GetOrganizationsResult, package_ref=_utilities.get_package()).value

    return AwaitableGetOrganizationsResult(
        id=pulumi.get(__ret__, 'id'),
        organizations=pulumi.get(__ret__, 'organizations'))
def get_organizations_output(id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('awx:index/getOrganizations:getOrganizations', __args__, opts=opts, typ=GetOrganizationsResult, package_ref=_utilities.get_package())
